...
- **Frameworks**: Google ADK, LangChain, LiteLLM
- **AI Models**: GPT-4, Gemini, Claude, Imagen 3
...
1. Clone the repository:
   ```bash
   git clone https://github.com/Rushabh-Runwal/Learning-AI-Agents.git
...
3. Follow the project-specific README for setup and installation

## Prerequisites

- Python 3.10+ (3.12 recommended for latest projects)
- Node.js 16+ (for JavaScript projects)
- Google Cloud account (for GCP-based projects)
- API keys for various AI services (OpenAI, Anthropic, etc.)
...
Learning-AI-Agents/
├── 01-renovation-agent/
├── 02-personal_assistant/
├── 03-education_counselor/
├── 04-ecommerce-cart-agent/
├── 05-LeetcodeAgent/
├── 06-system-health-agent/
├── 07-intuitive-course-generator/
├── 08-content-orchestration/
├── 09-travel-itinerary-agent/
...
This is a personal learning journey, but feedback and suggestions are welcome! Feel free to open issues or reach out.

## Connect

- **GitHub**: [Rushabh-Runwal](https://github.com/Rushabh-Runwal)
- **LinkedIn**: [Connect with me](https://www.linkedin.com/in/rushabh-runwal/)
- **YouTube**: [Watch the series](https://www.youtube.com/playlist?list=PL68NYUAEHLCEq-W9FEkCQeM0ZOGWI5dNa)

## License

Each project may have its own licensing terms. Please check individual project directories for specific license information.

## Acknowledgments

Special thanks to:
- Google Cloud for ADK and Agent Engine
- The open-source AI community
- All the frameworks and tools that made this possible

---

**Note**: This is an ongoing series. Projects will be added as they are completed. Star ⭐ the repository to follow along!
